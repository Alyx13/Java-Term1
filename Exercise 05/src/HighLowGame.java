...
public class HighLowGame {
	...
	/*
	 * method reset use the random api to find a random number between 1 and 10,
	 * a random number will be set and we have to guess it.
	 */
	public void reset() {
		int sum = 0;
	...
	/*
	 * method run will calculate the amount of fuel left and tell you weather you have
	 * guessed the right number or not, it will also tell you if you higher or lower
	 * from the number you have to guess. 
	 */
	public void run() {
